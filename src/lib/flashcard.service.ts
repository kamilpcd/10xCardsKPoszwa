...
export class FlashcardService {
   ...
   */
  async createFlashcardsInBatch(userId: string, flashcards: readonly CreateFlashcardDTO[]): Promise<FlashcardDTO[]> {
    ...
    if (error) {
      ...
      throw new DatabaseError("Failed to create flashcards", "CREATE_FLASHCARDS_ERROR", error.message);
    }
